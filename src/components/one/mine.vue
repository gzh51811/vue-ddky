  ...
  <!-- 头部开始 -->
        ...
        <div class="my-head cl">
                ...
                <div class="headcont">
                    <div class="userIconBox fl">
                        <img src="//img.ddky.com/c/wap/images/personal_ren.png?ddkycache=9c4c02ca63e20bbb2ee58955fe5cd851" alt="">
                    </div>
    ...
    <div class="my-main">
            <ul class="main-list cl">
                ...
                <li class="ddsl">
                    <a>
                        <span><van-icon name="point-gift-o" /></span>
                        <strong>叮当送礼</strong>
                    </a>
                </li>
                <li class="myyouhui">
...
.my-main .main-list li a, .my-nav .nav-list li a {
    font-size: 14px;
    line-height: 14px;
    color: #4a4a4a;
}
